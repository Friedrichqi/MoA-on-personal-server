...
def main():
    ...
    for item in test_instances:
        ...
        existed = False
        if os.path.exists("MATH_out_single_qwen2math.jsonl"):
            with open("MATH_out_single_qwen2math.jsonl", "r") as f:
                for line in f:
                    try:
        ...
        try:
            response = requests.post(
                ...
                json={
                    "model": "qwen2-math:7b",
                    "prompt": problem + '\nYou are a mathematician expert. Ensure your response is well-structured, coherent, and adheres to the highest standards of accuracy and reliability.',
                    "stream": False
                }
            )
        except TimeoutError:
        ...
        with open("MATH_out_single_qwen2math.jsonl", "a") as f:
            entry = {
                "problem": item["problem"],
